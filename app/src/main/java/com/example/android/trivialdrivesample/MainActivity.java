...
//    static final String SKU_1_MOUTH = "vip_1_month";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.ohter_page).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.check).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                skuList.add(SKU_1_MOUTH);
                mHelper.queryGoods(skuList, getPackageName(), new IabHelper.onResult() {
                    @Override
                    public void ProductIds(ArrayList<String> al) {
                        arrayList = new ArrayList<>();
                        arrayList.addAll(al);
                    }
                });
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
            ...
            Purchase premiumPurchase = inventory.getPurchase(SKU_1_MOUTH);
            ...
            Purchase gasPurchase = inventory.getPurchase(SKU_1_MOUTH);
            if (gasPurchase != null && verifyDeveloperPayload(gasPurchase)) {
                Log.d(TAG, "We have gas. Consuming it.");
                try {
                    mHelper.consumeAsync(inventory.getPurchase(SKU_1_MOUTH), mConsumeFinishedListener);
...
//         Received a broadcast notification that the inventory of items has changed
    ...
    public void init() {
        ...
        mHelper = new IabHelper(MainActivity.this, base64EncodedPublicKey, null);
    ...
    public void onBuyGasButtonClicked(View arg0) {
        ...
        payload = "";
        try {
            mHelper.launchPurchaseFlow(this, "vip_1_month", RC_REQUEST,
    ...
    public void onUpgradeAppButtonClicked(View arg0) {
        ...
        try {
            mHelper.launchPurchaseFlow(this, SKU_1_MOUTH, RC_REQUEST,
                    mPurchaseFinishedListener, payload);
        } catch (IabHelper.IabAsyncInProgressException e) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.d(TAG, "onActivityResultE(" + requestCode + "," + resultCode + "," + data);
        if (mHelper == null) return;
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            if (purchase.getSku().equals(SKU_1_MOUTH)) {
